      ...
      <div class="col-3 bg-light" id="sticky-sidebar">
        <div class="sticky-left">
          <div class="list-group w-100">
            ...
            <a href="#" class="list-group-item list-group-item-action"> - Add a new member</a>
            <a href="#" class="list-group-item list-group-item-action"> - Search a member</a>
            <a href="#" class="list-group-item list-group-item-action"> - Edit a member</a>
            <a href="#" class="list-group-item list-group-item-action"> - Delete a member</a>
          </div>
        </div>
      </div>
            ...
            <div class="modal-body" id="issueBookModalBody">
              <form>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="issueBookModalBookId" placeholder="8 digit number" required>
                </div>
                <div class="form-group">
                  <label for="issueBookModalBookName">Book Name</label>
                  <input type="text" class="form-control" id="issueBookModalBookName"
                    placeholder="Enter a matching keyword" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="issueBookModalMemberId" placeholder="8 digit number" required>
                </div>
                <div class="form-group">
